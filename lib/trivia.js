...
// Built-in Indonesian bank: shuffle the whole bank each refill so every
// question is used once before any repeats.
function loadIndonesianQuestions() {
...
async function fetchQuestions(triviaConfig = {}) {
  ...
  if (!triviaConfig || triviaConfig.source !== "opentdb") {
    return loadIndonesianQuestions();
  }
