...
// server.js/game.js care about: connected, comment, follow, gift, like,
// disconnected, error.
...
class TikTokClient extends EventEmitter {
  constructor(username) {
    ...
    // Taps on the screen. TikTok batches them: likeCount is how many taps
    // this message covers.
    this.connection.on(WebcastEvent.LIKE, (data) => {
      this.emit("like", { ...viewerOf(data), count: data.likeCount || 1 });
    });
